...
### Getting Started
- **[guides/START-HERE.md](guides/START-HERE.md)** - Welcome guide for new users
...
- **[guides/RESTART-INSTRUCTIONS.md](guides/RESTART-INSTRUCTIONS.md)** - How to restart the application
- **[guides/BACKUP_GUIDE.md](guides/BACKUP_GUIDE.md)** - Backup and restore operations

### Security & Compliance
- **[security/SYSTEM_SECURITY_DOCUMENTATION.md](security/SYSTEM_SECURITY_DOCUMENTATION.md)** - Security architecture and features
- **[security/AUDIT_LOGGING.md](security/AUDIT_LOGGING.md)** - Audit tracking system
- **[security/GEOLOCATION_LOGGING.md](security/GEOLOCATION_LOGGING.md)** - IP tracking and mapping

### Reviews & Analysis
- **[reviews/](reviews/)** - Code reviews, assessments, and analysis reports

### Testing
- **[testing/](testing/)** - Test results and quality reports

## Directory Structure

For a detailed map of the project, see **[architecture/PROJECT_STRUCTURE.md](architecture/PROJECT_STRUCTURE.md)**.
...
3. See [guides/START-HERE.md](guides/START-HERE.md) for a guided tour
