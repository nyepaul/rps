...
```bash
./bin/bump-version 3.10.13 "feat: configurable withdrawal rate and per-account advisory fee return drag"
```
...
| `src/static/version.json`, `src/static/index.html` | Version 3.10.13 |
