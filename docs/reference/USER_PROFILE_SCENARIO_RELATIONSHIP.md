...
API Keys:
  - Claude: REDACTED_ANTH_... (encrypted)
  - Gemini: REDACTED_GAPI_... (encrypted)
...
API Keys:
  - Claude: REDACTED_ANTH_... (encrypted, separate from Profile 1)
  - Gemini: REDACTED_GAPI_... (encrypted, separate from Profile 1)
...
API Keys:
  ...
  - Gemini: REDACTED_GAPI_... (encrypted, separate from other profiles)
...
User: john@example.com
  ...
  Profile 1: "Current Plan"
    API Keys:
      - Claude: REDACTED_ANTH_key-abc123
      - Gemini: REDACTED_GAPI_-key-xyz789

  Profile 2: "Conservative Plan"
    API Keys:
      - Claude: REDACTED_ANTH_key-def456  (different key)
      - Gemini: [Not configured]

  Profile 3: "Spouse Planning"
    API Keys:
      - Claude: [Not configured]
      - Gemini: REDACTED_GAPI_-key-uvw012  (different key)
```
...
Profile: "Current Plan"
  └── Encrypted Data (AES-256-GCM)
      └── {
            ...
            "assets": {...},
            "api_keys": {
                "claude_api_key": "REDACTED_ANTH_...",  # Encrypted
                "gemini_api_key": "REDACTED_GAPI_..."    # Encrypted
            }
          }
```
