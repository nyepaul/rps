...
function glossaryTerm(label, key) {
    return renderGlossaryTerm(label, key, { className: 'withdrawal-glossary-term', attrName: 'glossary' });
}

function wireGlossaryClicks(root) {
    wireGlossaryTerms(root, WITHDRAWAL_GLOSSARY, { className: 'withdrawal-glossary-term', attrName: 'glossary' });
}
