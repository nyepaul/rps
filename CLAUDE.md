...
RPS is a retirement and wealth planning system - a local-first financial planning application for Monte Carlo retirement simulations, tax optimization, and AI-powered financial advice. Version 3.10.16 with modular architecture. Licensed under **Apache License 2.0**.
...
### Version Scheme
- Current major.minor: **3.10.x** (Current: patch)
- Use patch versions: 3.10.1, 3.10.2, ..., 3.10.199
- Increment patch for ALL changes (features, fixes, improvements)
- Only move to 3.11.0 when explicitly requested

### Version Bump Process
```bash
./bin/bump-version 3.10.X "Description of changes"
```
