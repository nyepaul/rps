...
RPS is a retirement and wealth planning system - a local-first financial planning application for Monte Carlo retirement simulations, tax optimization, and AI-powered financial advice. Version 3.10.6 with modular architecture. Licensed under **Apache License 2.0**.
